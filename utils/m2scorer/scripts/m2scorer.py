...
import utils.m2scorer.scripts.levenshtein as levenshtein
from utils.m2scorer.scripts.util import paragraphs
from utils.m2scorer.scripts.util import smart_open
...
def m2score_main(preds, gold_file):
    """
    preds: str - list of the predicted sentences
    gold_file: str - file path of the gold sentences (m2 scoring format)
    """
    ...
    p, r, f1 = levenshtein.batch_multi_pre_rec_f1(preds, source_sentences, gold_edits, max_unchanged_words, beta, ignore_whitespace_casing, verbose, very_verbose)
