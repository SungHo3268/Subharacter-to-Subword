from KOMBO.tokenization.srcs.tokenizers import (
    JamoTokenizer,
    CharTokenizer,
    MorphemeTokenizer,
    SubwordTokenizer,
...
def get_tokenizer(tok_name, config_path="KOMBO/tokenization/utils/tok_info.cfg"):
    tokenizer = None
    if tok_name == 'jamo':
...
def get_vocab(tok_name, lang, vocab_size, bpe_corpus):
    ...
    raw_vocab = open(f"KOMBO/tokenization/resources/{tok}/tok.vocab", 'r', encoding='utf8').readlines()
    id2tok = []
