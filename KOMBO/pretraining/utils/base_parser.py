...
class ArgsBase:
    ...
    def add_base_args(parent_parser):
        ...
        # SUB^2 module
        parser.add_argument('--set_sub2', type=_bool, default=True)
        parser.add_argument('--sub2_tok_type', type=str, default='jamo_distinct', help="subword  |  morpheme  |  char")
        parser.add_argument('--sub2_tok_vocab_size', type=str, default='200', help="200  |  2k  |  4k  |  8k  |  16k  |  32k  |  64k")
        parser.add_argument('--sub2_lang', type=str, default='ko', help="ko  |  en")
        parser.add_argument('--sub2_bpe_corpus', type=str, default='wiki', help="wiki  |  aihub")
        parser.add_argument('--sub2_tok_name', type=str, help="It will be calculated in each script files.")
        parser.add_argument('--sub2_max_length', type=int, default=2048)
        parser.add_argument('--sub2_reducer', type=str, default="linear")
